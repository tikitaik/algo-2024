...
graph<checkpoint> initEventCheckpoints() {
    ...
    g.addNode(checkpoint(891, 863, 0));
    g.addNode(checkpoint(220, 964, 30));
    g.addNode(checkpoint(365, 1193, 80));
    g.addNode(checkpoint(336, 1035, 50));
    g.addNode(checkpoint(478, 878, 60));
    g.addNode(checkpoint(344, 859, 50));
    g.addNode(checkpoint(518, 1260, 50));
    g.addNode(checkpoint(648, 1112, 40));
    g.addNode(checkpoint(643, 815, 50));
    g.addNode(checkpoint(571, 738, 70));
    g.addNode(checkpoint(716, 567, 50));
    g.addNode(checkpoint(778, 1152, 20));
    g.addNode(checkpoint(838, 1088, 60));
    g.addNode(checkpoint(822, 954, 30));
    g.addNode(checkpoint(723, 878, 30));
    g.addNode(checkpoint(871, 753, 40));
    g.addNode(checkpoint(736, 690, 40));
    g.addNode(checkpoint(840, 490, 60));
    g.addNode(checkpoint(1005, 1143, 50));
    g.addNode(checkpoint(917, 968, 20));
    g.addNode(checkpoint(969, 844, 20));
    g.addNode(checkpoint(1025, 677, 40));
    g.addNode(checkpoint(1180, 1246, 40));
    g.addNode(checkpoint(1103, 990, 40));
    g.addNode(checkpoint(1244, 967, 40));
    g.addNode(checkpoint(1168, 767, 30));
    g.addNode(checkpoint(1122, 613, 50));
    g.addNode(checkpoint(1250, 490, 30));
    g.addNode(checkpoint(1392, 1252, 90));
    g.addNode(checkpoint(1310, 1070, 80));
    g.addNode(checkpoint(1288, 812, 80));
    g.addNode(checkpoint(1300, 672, 60));
    g.addNode(checkpoint(1487, 447, 50));
    g.addNode(checkpoint(1380, 350, 40));
    g.addNode(checkpoint(1494, 181, 80));
    g.addNode(checkpoint(1472, 1240, 60));
    g.addNode(checkpoint(1535, 696, 70));
    g.addNode(checkpoint(1555, 569, 50));
    g.addNode(checkpoint(1550, 350, 90));
    g.addNode(checkpoint(1620, 175, 90));
